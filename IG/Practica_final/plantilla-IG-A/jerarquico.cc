...
void ObjJerarquico::draw( const ModoVis modo_vis, const bool usar_diferido, const int suavizado_actual, const int material_actual)
{
   assert( objparam != nullptr );
   objparam->draw( modo_vis, usar_diferido, suavizado_actual, material_actual);
}
